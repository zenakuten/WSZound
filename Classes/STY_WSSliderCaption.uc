...
class STY_WSSliderCaption extends STY2SliderCaption;
...
defaultproperties
{
	...
	ImgColors(4)=(B=200,G=200,R=200,A=150)
	Images(0)=Texture'GUI.WSButton'
	Images(1)=Texture'GUI.WSWatch'
	Images(2)=Texture'GUI.WSWatch'
	Images(3)=Texture'GUI.WSButton'
	Images(4)=Texture'GUI.WSNone'
}