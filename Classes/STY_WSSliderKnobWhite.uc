...
defaultproperties
{
	...
	Images(0)=Texture'GUI.WSSliderKnobWhite'
	Images(1)=Texture'GUI.WSSliderKnobWhite'
	Images(2)=Texture'GUI.WSSliderKnobWhite'
	Images(3)=Texture'GUI.WSSliderKnobWhite'
	Images(4)=Texture'GUI.WSSliderKnobWhite'
}
