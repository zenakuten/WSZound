...
#exec TEXTURE IMPORT NAME=checkBoxX_d GROUP=GUI FILE=Textures\checkBoxX_d.tga MIPS=off ALPHA=1

defaultproperties
{
     CheckedOverlay(0)=Texture'2K4Menus.Controls.checkBoxX_b'
     CheckedOverlay(1)=Texture'2K4Menus.Controls.checkBoxX_w'
     CheckedOverlay(2)=Texture'GUI.checkBoxX_f'
     CheckedOverlay(3)=Texture'GUI.checkBoxX_p'
     CheckedOverlay(4)=Texture'GUI.checkBoxX_d'
