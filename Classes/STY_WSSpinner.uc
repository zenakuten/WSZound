...
defaultproperties
{
	...
	Images(0)=Texture'GUI.WSSpinnerBlur'
	Images(1)=Texture'GUI.WSSpinnerWatch'
	Images(2)=Texture'GUI.WSSpinnerWatch'
	Images(3)=Texture'GUI.WSSpinnerBlur'
	Images(4)=Texture'GUI.WSSpinnerBlur'
}