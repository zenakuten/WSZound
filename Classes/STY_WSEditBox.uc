...
defaultproperties
{
	...
	Images(0)=Texture'GUI.WSEditBlur'
	Images(1)=Texture'GUI.WSEditWatch'
	Images(2)=Texture'GUI.WSEditFocus'
	Images(3)=Texture'GUI.WSEditFocus'
	Images(4)=Texture'GUI.WSEditDisable'
}